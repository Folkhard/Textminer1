...
def bar_plot(wordlist, N, title="Occurence count"):
    ...
    ycountlist=[v/numbersentences*100 for k,v in wordlist]
    ...
    pylab.title(title)
    plt.ylabel('# of occurences / 100 sentences')
    plt.show()
...
- Number of distinct words as % of total words
- XXX
"""

def textrichness():
    print(" Number of sentences: ",numbersentences,'\n',"Number of words: ",numberwords,'\n',"number of words per sentence: ",round(numberwords/numbersentences,2),'\n',"Number of distinct words as % of total words: ",round(numberuniquewords/numberwords,2)*100,"%")
